...
const FlashDeals = () => {
    ...
    useEffect(() => {
        ...
        api.get('/products/flash-deals').then((res) => setProducts(res.data.products)).catch((error: any) => toast.error(
            ...
            <div className="bg-linear-to-r from-app-orange to-app-orange-dark text-white py-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="flex-center gap-2 mb-3">
                        <Zap className="size-6 fill-white"></Zap>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {
                    loading ? (<Loading></Loading>) : (
                        products.length === 0 ? (<div className="text-center py-16">
                            <Zap className="size-16 text-app-border mx-auto mb-4"></Zap>
