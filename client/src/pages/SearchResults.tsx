            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                {loading ? (<Loading></Loading>) : products.length === 0 ?
                    (<div className="text-center py-20">
                        <Search className="size-16 text-app-border mx-auto mb-4"></Search>
                        <h2 className="text-xl font-semibold text-app-green mb-2">no results found</h2>
                        <p className="text-sm text-app-text-light mb-6 max-w-md mx-auto">we couldnt find any products matching '{query}' try a different search term</p>
