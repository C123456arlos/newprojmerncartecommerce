            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:px-10">
                <div className="text-center md:text-left">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                        ...
                        <button className="px-6 py-3 bg-white/20 font-semibold rounded-xl hover:bg-white/20 transition-colors border border-white/20 text-white">google play</button>
                    </div>
                </div>
                <img src={assets.delivery_truck} alt="delivery truck" className="max-w-60 sm:max-w-120 xl:pr-10"></img>
            </div>
        </section>
    )
}
