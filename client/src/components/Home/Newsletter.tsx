        ...
        <section className="bg-white py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-auto shadow-xs mt-32 mb-20">
            <div className="max-w-2xl mx-auto text-center">
                <div className="size-16 bg-white rounded-xl flex-center mx-auto mb-6 shadow">
                    <MailIcon className="size-8 text-app-green" strokeWidth={1.5}></MailIcon>
                </div>
                <h2 className="text-3xl font-semibold text-app-green mb-4">subscribe to our newsletter</h2>
                <p className="text-appptext-light mb-8 text-base">get weekly updates on fresh produce seasonal offers and exclusive discounts right to your inbox</p>
                <form onSubmit={(e) => e.preventDefault()}
                    className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                    <input type="email" placeholder="enter your email address" required className="flex-1 px-5 py-3.5 rounded-xl border border-app-border focus:border-app-green focus:ring bg-white text-sm transition-all"></input>
