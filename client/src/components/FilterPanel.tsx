        ...
        <div className="space-y-6">
            <div>
                ...
                <div className="space-y-1.5">
                    {categoriesWithAll.map((cat: any) => (<button key={cat.slug}
            ...
            <div>
                ...
                <div className="flex items-center gap-2">
                    <input type="number" placeholder="min" value={minPrice} onChange={(e) => updateFilter('minPrice', e.target.value)} className="w-full px-3 py-2 text-sm bg-white rounded-lg border not-focus:border-app-border"></input>
                    <span className="text-app-text-light">-</span>
                    <input type="number" placeholder="max" value={maxPrice} onChange={(e) => updateFilter('maxPrice', e.target.value)} className="w-full px-3 py-2 text-sm bg-white rounded-lg border not-focus:border-app-border"></input>
                </div>
            </div>
            {hasFilters && (
